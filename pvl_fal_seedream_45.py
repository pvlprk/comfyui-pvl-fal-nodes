...
class PVL_fal_Seedream45_API:
    ...
    def _collect_image_urls(self, images: List[Optional[torch.Tensor]], debug: bool = False):
        """
    ...
    def generate_image(
        ...
        try:
            ...
            image_urls = self._collect_image_urls(images, debug=debug_log) if has_image_input else []
