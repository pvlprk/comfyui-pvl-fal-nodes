...
class PVL_fal_KontextDev_API:
    ...
    def edit_image(self, prompt, image, seed, num_inference_steps, guidance_scale, 
                  num_images, output_format, sync_mode, acceleration, resolution_mode, 
                  enable_safety_checker=True, **kwargs):
        ...
        result = ApiHandler.submit_and_get_result("fal-ai/flux-kontext/dev", arguments)
